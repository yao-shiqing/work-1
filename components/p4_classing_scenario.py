...
def estimate_scenario(a_env,t,state_matrix,action_matrix,reward_matrix):
    ...
    for k in range(n_agents):
        ...
        print(f'agent{k+1}','action_selscted:',np.argmax(action_matrix[t,k,:]))
...
def scenario_3_reward(k, t, action_matrix, state_matrix,a_env,reward_matrix):
    ...
    lamda_3_t0 = 0 if np.isinf(lamda_3_t0) and lamda_3_t0 == 1 + np.inf else lamda_3_t0
    ...
    print('scenario_3_reward:', r3,f'; ra:{ra}; rb:{rb}')
