# 测试版05 -- reward 修正检查 -- 方向修正(self.t问题)
...
class RewardAllocation:
    def __init__(self, env,  batch , t, state_t, ):
        ...
        self.action_matrix = self.batch['actions'][:,self.t-1]
    ...
    def scenario_reward(self,nt,nr,tar,sr):
        ...
        # print('state_t-1: ', self.batch['state'][:,self.t-1])
        # print('state_t: ', self.batch['state'][:,self.t])
        # print('state_t+1: ', self.batch['state'][:,self.t+1])
        # print('g_state_t0: ',self.g_state_t0)
        # print('g_state_t1: ',self.g_state_t1)
        # print('obs_matrix: ',self.obs_matrix)
        # print('self.batch[obs][t-1]',self.batch['obs'][:,self.t-1])
        # print('self.batch[obs][t+1]',self.batch['obs'][:,self.t+1])
