# 测试版03 -- 统一下 reward 取值范围；修改视距，修改划分标准
...
class RewardAllocation:
    ...
    def scenario_reward(self,nt,nr,tar):
        # self.fig_t()
        ...
        for k in range(self.n_agents):
            ...
            self.sight_modification(self,obs_k,k,b1,b2,n)
        ...
        for k in range(self.n_agents):
            ...
            nt,nr,tar = self.tarcit(nt,nr,tar,k,lamda_id)
        return self.reward_matrix,nt,nr,tar
    ...
    def tarcit(self,nt,nr,tar,k,lamda_id):
        nt[lamda_id-1] += 1
